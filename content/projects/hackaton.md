...
description: >
  ...
  secure passwords.
tools:
  Roblox Studio, Lua(u), Energy Drinks, Chocolate Milk
description_long: >
  At LA Hacks 2026, two friends and I decided to go against the grain. In an
  AI-first environment where everyone was trying to create the newest
  AI-augmented software, we chose a different approach- a Roblox game. In 
  thirty-six hours, the three of us learned the ins and outs of Roblox 
